...
<html lang="en">
<head>
<title>MOLINI | <?php echo $_smarty_tpl->tpl_vars['page']->value;?>
</title>
<meta charset="utf-8">
...
>
<?php echo '<script'; ?>
 src="../../js/jquery.sparkline.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
...
>
<?php echo '<script'; ?>
 src="../../js/jquery.knob.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="../../js/bootstrap3-wysihtml5.all.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
